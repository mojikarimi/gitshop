...
urlpatterns = [
    ...
    re_path(r'^panel_add_faq_category$', mainview.panel_add_faq_category, name='panel_add_faq_category'),
    re_path(r'^panel_delete_faq_category/(?P<pk>\d+)$', mainview.panel_delete_faq_category,
            name='panel_delete_faq_category'),
    re_path(r'^panel_edit_faq_category/(?P<pk>\d+)$', mainview.panel_edit_faq_category,
            name='panel_edit_faq_category'),
    re_path(r'^panel_add_symbol$', mainview.panel_add_symbol, name='panel_add_symbol'),
    re_path(r'^panel_edit_symbol/(?P<pk>\d+)$', mainview.panel_edit_symbol,
            name='panel_edit_symbol'),
    re_path(r'^panel_delete_symbol/(?P<pk>\d+)$', mainview.panel_delete_symbol,
            name='panel_delete_symbol'),
    re_path(r'^panel_add_social_networks$', mainview.panel_add_social_networks, name='panel_add_social_networks'),
    re_path(r'^panel_edit_social_networks/(?P<pk>\d+)$', mainview.panel_edit_social_networks,
            name='panel_edit_social_networks'),
    re_path(r'^panel_delete_social_networks/(?P<pk>\d+)$', mainview.panel_delete_social_networks,
            name='panel_delete_social_networks'),
    # chat views
